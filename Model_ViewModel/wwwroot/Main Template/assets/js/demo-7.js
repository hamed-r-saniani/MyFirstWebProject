...
function ecCheckCookie() {
    ...
    ecCheckCookie(), e(".clear-cookie").on("click", function (e) {
        ...
        e(".ec-sidebar-block .ec-sb-block-content ul li ul").addClass("ec-cat-sub-dropdown"), e(".ec-sidebar-block .ec-sidebar-block-item").on("click", function () {
            var s = e(this).closest(".ec-sb-block-content").find(".ec-cat-sub-dropdown");
            s.slideToggle("slow"), e(".ec-cat-sub-dropdown").not(s).slideUp("slow")
        })
    }), e(document).ready(function () {
    ...
    const s = document.getElementById("ec-sliderPrice");
    if (s) {
        const e = parseInt(s.dataset.min),
            o = parseInt(s.dataset.max),
            t = parseInt(s.dataset.step),
            i = document.querySelectorAll("input.filter__input");
        noUiSlider.create(s, {
            start: [e, o],
            connect: !0,
            step: t,
        ...
        }), s.noUiSlider.on("update", (e, s) => {
            i[s].value = e[s]
        }), i.forEach((e, o) => {
            e.addEventListener("change", () => {
                s.noUiSlider.setHandle(o, e.value)
            })
        })
    }
    var o, t, i, n;
    jQuery(".select-option").click(function () {
    ...
    }), o = e(".ec-side-toggle"), t = e(".ec-side-cart"), i = e(".mobile-menu-toggle"), o.on("click", function (s) {
        s.preventDefault();
        var o = e(this),
            t = o.attr("href");
        ...
        e(".ec-side-cart-overlay").fadeOut(), t.removeClass("ec-open"), i.find("a").removeClass("close")
    ...
    var c = e(".ec-pro-color, .ec-product-tab, .shop-pro-inner, .ec-new-product, .ec-releted-product, .ec-checkout-pro").find(".ec-opt-swatch");
    ...
    e(window).on("load", function () {
    ...
    }), e(".ec-sidebar-toggle").on("click", function () {
        e(".ec-side-cat-overlay").fadeIn(), e(".sidebar-dis-991").addClass("ec-open")
    }), e(".ec-close").on("click", function () {
        e(".sidebar-dis-991").removeClass("ec-open"), e(".ec-side-cat-overlay").fadeOut()
    }), e(".ec-side-cat-overlay").on("click", function () {
        e(".sidebar-dis-991").removeClass("ec-open"), e(".ec-side-cat-overlay").fadeOut()
    }), setInterval(function () {
        e(".recent-purchase").stop().slideToggle("slow")
    }, 1e4), e(".recent-close").click(function () {
        e(".recent-purchase").stop().slideToggle("slow")
    }), e(".ec-new-slider, .ec-special-slider, .ec-best-slider").slick({
        rtl: true,
        rows: 4,
        dots: !1,
        arrows: !0,
        ...
        d(e(this).attr("id"), "body-bg-1")
    }), e(".back-bg-2").on("click", function (s) {
        d(e(this).attr("id"), "body-bg-2")
    }), e(".back-bg-3").on("click", function (s) {
        d(e(this).attr("id"), "body-bg-3")
    }), e(".back-bg-4").on("click", function (s) {
        d(e(this).attr("id"), "body-bg-4")
